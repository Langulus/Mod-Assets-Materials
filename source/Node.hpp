...
public:
   REFLECT(MaterialNode);
   MaterialNode() = delete;
   MaterialNode(DMeta, CGeneratorMaterial*);
   MaterialNode(DMeta, MaterialNode*, const Verb& = {});
